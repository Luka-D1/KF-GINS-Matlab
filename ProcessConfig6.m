...
function cfg = ProcessConfig6()

    param = Param();

    %% filepath
    cfg.imufilepath = 'dataset4\KF_IMU.txt';
    cfg.gnssfilepath = 'dataset4\KF_GNSS_SPP.txt';
    cfg.odofilepath = '';
    cfg.outputfolder = 'dataset5';
    ...
    % ======= 新增：IMU 降采样配置 =======
    cfg.downsample_factor = 1 % 1表示不降采样(100Hz)，2表示降到50Hz，5表示降到20Hz，10表示降到10Hz
